...
- **Multi-page structure** — each section is its own page: Overview, Conversation, Memory, Actions, Everyday, Home, Work, Privacy, Design — reached through an always-collapsed side drawer menu, with Previous/Next pagination between pages
...
- `assets/hero-coast.jpg` — coastal sunset render used for the Overview hero (`assets/hero-coast-original.png` is the original)
